        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GraduationUniversity = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomConsultationFee = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClinicBranches_Doctors_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CancelledByPatient = table.Column<bool>(type: "bit", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                    ReasonForVisit = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    AdministrativeNotes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorSchedules_ClinicBranches_ClinicBranchId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeightAtVisit = table.Column<double>(type: "float", nullable: true),
                    ...
                    PhysicalExaminationNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    PrescriptionNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LabOrderNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RadiologyOrderNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RecommendedFollowUpDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    WasAIAssisted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InputVitalsSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    TopPrediction = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TopConfidenceScore = table.Column<double>(type: "float", nullable: false),
                    DoctorAction = table.Column<int>(type: "int", nullable: false),
                    CorrectedDiagnosis = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AIDiagnosisLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AIDiagnosisLogs_ConsultationRecords_ConsultationRecordId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PatientId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ConsultationRecordId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    IsAnalyzedByAI = table.Column<bool>(type: "bit", nullable: false),
                    AIAnalysisResultJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalAttachments_ConsultationRecords_ConsultationRecordId",
                        column: x => x.ConsultationRecordId,
                        principalTable: "ConsultationRecords",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsultationRecordId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prescriptions_ConsultationRecords_ConsultationRecordId1",
                        column: x => x.ConsultationRecordId1,
                        principalTable: "ConsultationRecords",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AIDiagnosisLogs_ConsultationRecordId",
                table: "AIDiagnosisLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicBranches_DoctorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSchedules_ClinicBranchId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalAttachments_ConsultationRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_ConsultationRecordId1",
                table: "Prescriptions",
                column: "ConsultationRecordId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_UniqueCode",
                table: "Prescriptions",
                column: "UniqueCode",
                unique: true,
